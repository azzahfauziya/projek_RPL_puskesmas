                ...
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        <tr class="border-b dark:border-gray-700">
                            <td class="py-3 px-4">O-123</td>
                            <td class="py-3 px-4">Aito</td>
                            <td class="py-3 px-4">100</td>
                            <td class="py-3 px-4">Rp 3000</td>
                            <td class="py-3 px-4">Tablet</td>
                        </tr>
                        <tr class="border-b dark:border-gray-700">
                            <td class="py-3 px-4">O-124</td>
                            <td class="py-3 px-4">Esta</td>
                            <td class="py-3 px-4">150</td>
                            <td class="py-3 px-4">Rp 4000</td>
                            <td class="py-3 px-4">Kapsul</td>
                        </tr>
                        <tr class="border-b dark:border-gray-700">
                            <td class="py-3 px-4">O-123</td>
                            <td class="py-3 px-4">Aito</td>
