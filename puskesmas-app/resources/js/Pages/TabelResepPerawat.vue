            ...
            <main class="flex-1 overflow-y-auto p-8">
                ...
                <div class="grid grid-cols-4 gap-4 mb-6">
                    <div class="col-span-3">
                        <h1 class="text-2xl font-extrabold text-[#144B29]">Tabel Resep</h1>
                    </div>
                    <div>
                        <input v-model="search" type="text"
                            ...
                            placeholder="Cari berdasarkan no.reg atau nama" />
                    </div>
                </div>
                        ...
                        <table class="table-auto w-full text-sm">
                            <thead>
                                <tr class="bg-gray-200">
                                    ...
                                    <th class="py-3 px-4 text-left">Dosis</th>
                                    <th class="py-3 px-4 text-left">Aturan Pakai</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="item in resepTampil" :key="item.id_detail"
                                    class="border-b border-gray-700 hover:bg-gray-100">
                                    <td class="py-3 px-4">
                                        {{ item.resep?.rekam_medis?.no_registrasi }}
                                    </td>
