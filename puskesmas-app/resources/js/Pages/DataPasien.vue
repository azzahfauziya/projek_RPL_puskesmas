                                ...
                                <tr v-for="item in paginated" :key="item.no_rm"
                                    ...
                                    <td class="py-3 items-center justify-center text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            <button class="bg-emerald-700 hover:bg-emerald-800 text-white font-semibold px-4 py-1 rounded-lg shadow-md">
                                                Daftar
                                            </button>
                                            <button class="bg-slate-600 hover:bg-slate-500 text-white font-semibold px-4 py-1 rounded-lg shadow-md">
                                                Riwayat
                                            </button>
                                        </div>
                                    </td>
